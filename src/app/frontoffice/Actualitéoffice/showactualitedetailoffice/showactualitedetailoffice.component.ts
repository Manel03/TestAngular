...
@Component({
  selector: 'app-showactualitedetailoffice',
  templateUrl: './showactualitedetailoffice.component.html',
  styleUrls: ['./showactualitedetailoffice.component.scss']
})
export class ShowactualitedetailofficeComponent {
